...
public class BeanEvento {
	...
	private List<Tblevento> todosEventosActivos;
	private List<Tblevento> todosEventosTerminados;
	private List<Tbltpevento> listaTiposEvnts;
	private Tblevento eventoC;
	// Jornada
	...
	public void iniciar() {
		...
		todosEventosActivos = managerQR.listaEventosPublicados(beanUsuario.getU().getIdUsuario());
		todosEventosTerminados = managerQR.listaEventosTerminados(beanUsuario.getU().getIdUsuario());
	...
	public void cargarEvento(Tblevento evento) throws IOException {
        eventoC=evento;
		listaJoranasIdEvnt = managerQR.listaJornadas(evento.getIdEvnt());
		FacesContext contex = FacesContext.getCurrentInstance();
		contex.getExternalContext().redirect("GestionarEvento.xhtml");
	...
	public List<Tblhorario> mostrarHoraios(Tbljornada j){
		return managerQR.listaHorarios(j.getIdJornada());
	}
	...
	public Tblevento getEventoC() {
		return eventoC;
	}

	public void setEventoC(Tblevento eventoC) {
	...
	public List<Tblevento> getTodosEventosActivos() {
		return todosEventosActivos;
	}

	public void setTodosEventosActivos(List<Tblevento> todosEventosActivos) {
		this.todosEventosActivos = todosEventosActivos;
	}

	public List<Tblevento> getTodosEventosTerminados() {
		return todosEventosTerminados;
	}

	public void setTodosEventosTerminados(List<Tblevento> todosEventosTerminados) {
		this.todosEventosTerminados = todosEventosTerminados;
	}
